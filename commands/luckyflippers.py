...
def execute(parser, bot, user, args):
    ...
    if topwhat > 10:
        bot.addressUser(user, "For the full luckyflippers leaderboard go here: http://twitchbot.dabomstew.com/goldenrod/leaderboards.php?board=luckyflippers")
        return
    ...
    if topwhat == 1:
        ...
        finalMessage = "The luckiest coinflipper is %s with %d coin wins and %d coin losses." % (topPlayer["twitchname"], topPlayer["coins_won"], topPlayer["coins_lost"])
        ...
        finalMessage = "The luckiest %d coinflippers are: " % topwhat
